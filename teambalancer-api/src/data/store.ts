...
// Initialized with your mock data so it loads on server start
export let matchesStore: Match[] = [
  {
    id: "1", date: "2026-03-10", winner: "Team A", scoreA: 21, scoreB: 19,
  ...
  {
    id: "2", date: "2026-03-08", winner: "Team B", scoreA: 18, scoreB: 21,
  ...
  {
    id: "3", date: "2026-03-05", winner: "Team A", scoreA: 21, scoreB: 17,
